    ...
    <div className="">
      ...
      <div className="flex mb-[25px]">
        {Array.from({ length: 6 }).map((_, index) => (
          <ShortShowcase
            key={index}
            thumbnail="/images/home/short-thumbnail.png"
            title="Tanjiro's ability to learn any Breathing Styles! Demon..."
            views="2.1M"
          />
        ))}
      </div>
      <div className="w-full mb-[28px] relative">
        ...
        <div className="border-b-[1px] absolute -z-10 top-[50%] border-solid min-h-[1px] w-full border-[#0000001a]"></div>
      </div>
    </div>
  );
}
