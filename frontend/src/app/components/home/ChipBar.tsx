...
function ChipBar() {
    ...
    return (
      <>
        <div className="absolute inset-0 z-10 pointer-events-none ">
          {canScrollPrev && (
            <div className="absolute inset-y-0 left-0 max-w-24 w-full bg-gradient-to-r from-white via-white/0 to-transparent" />
          )}
          {canScrollNext && (
            <div className="absolute inset-y-0 right-0 max-w-24 w-full bg-gradient-to-l from-white via-white/0 to-transparent" />
          )}
        </div>
      </>
    );
  ...
  return (
    <div className="py-[18px] fixed bg-white z-[9] ">
